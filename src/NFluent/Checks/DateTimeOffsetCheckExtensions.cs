    ...
    public static class DateTimeOffsetCheckExtensions
    {
        ...
        public static ICheckLink<ICheck<DateTimeOffset>> IsEqualToIgnoringMillis(this ICheck<DateTimeOffset> check, DateTimeOffset other)
        {
            ExtensibilityHelper.BeginCheck(check)
                .FailWhen(sut => sut.UtcDateTime.Round(TimeUnit.Seconds) != other.UtcDateTime.Round(TimeUnit.Seconds), "The {0} is not equal to the {1} (ignoring milliseconds).")
        ...
        {
            ExtensibilityHelper.BeginCheck(check)
                .FailWhen(sut => sut.UtcDateTime.Round(TimeUnit.Minutes) != other.UtcDateTime.Round(TimeUnit.Hours), "The {0} is not equal to the {1} (ignoring minutes).")
